<template>
  ...
  <div class="page-box">
    <!-- 搜索选项 -->
    <el-form v-if="!!search" class="search" :model="searchModel" :inline="true" label-position="left" :label-width="search.labelWidth" ref="searchForm">
    ...
    <!-- table表格栏 -->
    <div class="table">
      <el-table v-loading="isLoading" :data="tableData" @selection-change="handleSelectionChange" v-bind="$attrs" v-on="$listeners" ref="table">
        <el-table-column
...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      ...
      console.log(searchModel, 'kkkksearchModel');
